{set scope=global persistent_variable=hash('title', 'Add GIS Relation'|i18n('design/standard/ezoe'),
...
<div class="upload-view">
    <form action={concat('xrowgis/upload/', $object_id, '/', $object_version, '/auto/1' )|ezurl} method="post" target="embed_upload" name="EmbedForm" id="EmbedForm" enctype="multipart/form-data" onsubmit="document.getElementById('upload_in_progress').style.display = '';">
...
{*include uri="design:xrowgis/upload/box_search.tpl" box_class_filter_array=$class_filter_array*}
{include uri="design:xrowgis/upload/box_browse.tpl" box_class_filter_array=$class_filter_array}
</div>
     </form>
</div>