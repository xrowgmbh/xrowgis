...
/*! \file xrowgisfunctioncollection.php
*/

/*!
  \class xrowGISFunctionCollection xrowgisfunctioncollection.php
...
class xrowGISFunctionCollection
{
    /*!
     Constructor
    */
    function xrowGISFunctionCollection()
    {
    }
    ...
    {
        include_once( "extension/xrowgis/datatypes/xrowgis/xrowgisposition.php" );
        ...
        $searchResult = xrowGISPosition::search( $x, $y, $distance,
                                           $parameters,
                                           $searchArray );
